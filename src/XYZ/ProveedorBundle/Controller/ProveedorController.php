...
use XYZ\ProveedorBundle\Entity\Proveedor;
...
class ProveedorController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $proveedors = $em->getRepository('ProveedorBundle:Proveedor')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('XYZ\ProveedorBundle\Form\ProveedorType', $proveedor);
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('proveedor_show', array('idproveedor' => $proveedor->getIdproveedor()));
        }
    ...
    {
        $deleteForm = $this->createDeleteForm($proveedor);
        $editForm = $this->createForm('XYZ\ProveedorBundle\Form\ProveedorType', $proveedor);
        $editForm->handleRequest($request);

        if ($editForm->isSubmitted() && $editForm->isValid()) {
            $this->getDoctrine()->getManager()->flush();

            return $this->redirectToRoute('proveedor_edit', array('idproveedor' => $proveedor->getIdproveedor()));
        }
    ...
    private function createDeleteForm(Proveedor $proveedor)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('proveedor_delete', array('idproveedor' => $proveedor->getIdproveedor())))
            ->setMethod('DELETE')
            ->getForm()
        ;
    }
